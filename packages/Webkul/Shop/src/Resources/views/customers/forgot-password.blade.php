...
>
    ...
    <div class="container mt-20 max-1180:px-5 max-md:mt-12">
        ...
        >
            <h1 class="font-nunito text-4xl max-md:text-3xl max-sm:text-xl">
                @lang('shop::app.customers.forgot-password.title')
            </h1>
            ...
            <div class="mt-14 rounded max-sm:mt-8">
                <x-shop::form :action="route('shop.customers.forgot_password.store')">
                    ...
                    <div class="mt-8 flex flex-wrap items-center gap-9 max-sm:mt-0 max-sm:justify-center max-sm:text-center">
                        <button
                            class="primary-button m-0 mx-auto block w-full max-w-[374px] rounded-2xl px-11 py-4 text-center text-base max-md:max-w-full max-md:rounded-lg max-md:py-3 max-sm:py-1.5 max-sm:text-sm"
                            type="submit"
                        >
